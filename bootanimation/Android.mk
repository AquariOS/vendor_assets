...
$(TARGET_GENERATED_BOOTANIMATION): $(SOONG_ZIP)
	...
	@rm -rf $(dir $@)
	@mkdir -p $(dir $@)
	$(hide) tar xfp vendor/assets/bootanimation/bootanimation.tar -C $(INTERMEDIATES)
	$(hide) if [ $(TARGET_SCREEN_WIDTH) -lt $(TARGET_SCREEN_WIDTH) ]; then \
	...
	vendor/assets/bin/mogrify -resize $$RESOLUTION -colors 250 $(INTERMEDIATES)/*/*.png; \
	echo "$$IMAGESCALEWIDTH $$IMAGESCALEWIDTH 15" > $(INTERMEDIATES)/desc.txt; \
	cat vendor/assets/bootanimation/desc.txt >> $(INTERMEDIATES)/desc.txt
